...
const WorkoutA: React.FC = () => {
  ...
  useEffect(() => {
    console.log('🚀 WorkoutA - Iniciando inicialização...');
    const workoutData = workoutsData.find(w => w.id === 'A');
  ...
  useEffect(() => {
    if (session.workoutStarted) {
      ...
      console.log('🔄 WorkoutA - Opções de exercícios atualizadas:', options.length);
    }
  ...
  const handleFinalizeWithCalories = async (calories: number, heartRate?: number) => {
    try {
      ...
      console.log('🔥 FINALIZANDO TREINO A:', {
        durationInSeconds,
    ...
    return (
      <div className="min-h-screen bg-primary-dark flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-xl font-bold text-white mb-2">Carregando treino A...</h2>
  ...
  if (!groups || groups.length === 0) {
    console.log('⚠️ WorkoutA - Groups ainda não carregou');
    return (
      <div className="min-h-screen bg-primary-dark flex items-center justify-center">
        <div className="text-center">
      ...
      <div className="min-h-screen bg-primary-dark">
        <div className="container mx-auto px-4 py-6 max-w-6xl">
          ...
          <header className="bg-gradient-to-r from-secondary-dark to-black rounded-2xl p-6 mb-8 
            ...
            >
              <i className="fas fa-arrow-left text-accent-red group-hover:translate-x-[-3px] transition-transform"></i>
              <span className="text-text-secondary group-hover:text-white">Voltar</span>
            </Link>
            
            <div className="flex items-center gap-6">
              <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-accent-red to-accent-purple 
              ...
              <div>
                ...
                <p className="text-text-secondary uppercase tracking-wider text-sm font-inter">
                  Peito • Ombro • Tríceps • Perna Anterior
                </p>
              </div>
            </div>
            ...
            <div className="w-full md:w-72">
              ...
              <div className="h-3 bg-white/5 rounded-full overflow-hidden">
                <div 
                  className="h-full bg-gradient-to-r from-accent-red to-accent-green transition-all duration-500"
          ...
          <main className="bg-gradient-to-b from-secondary-dark/50 to-transparent 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
              ...
              <div className="bg-gradient-to-br from-secondary-dark to-black rounded-xl p-6 
                border border-white/5 text-center">
                <i className="fas fa-fire text-4xl text-accent-red mb-4"></i>
                <h3 className="text-4xl font-bold text-white mb-2">
                  {totalSets}
                </h3>
                <p className="text-text-secondary uppercase tracking-wider text-sm">
          ...
          <footer className="bg-gradient-to-r from-secondary-dark to-black rounded-2xl p-8 
            ...
            <div className="flex items-center gap-4 text-text-secondary">
              <i className="fas fa-info-circle text-xl text-accent-red"></i>
              <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button 
                ...
                className={`px-6 py-3 bg-gradient-to-r from-accent-red to-accent-purple 
                  text-white font-bold rounded-xl transition-all flex items-center gap-3
                  ${canFinishWorkout() 
                    ? 'hover:scale-105 shadow-lg hover:shadow-accent-red/30' 
