    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0A0F1C] via-[#1A1F2E] to-[#0D0F1A]">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-12">
          ...
          {/* STATS CARDS COM LOADING ANIMATION */}
          {loading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="group bg-gradient-to-br from-secondary-dark/50 to-black/50 
                rounded-2xl p-6 border border-white/10 hover:border-accent-red/30 
                transition-all duration-300 hover:scale-105 hover:shadow-xl">
                <div className="flex items-center justify-between mb-3">
                  <i className="fas fa-calendar-check text-2xl text-accent-red 
                ...
                <p className="text-text-secondary text-sm">Total de Treinos</p>
                <p className="text-3xl font-bold text-white">{stats?.totalWorkouts || 0}</p>
              </div>

              <div className="group bg-gradient-to-br from-secondary-dark/50 to-black/50 
                rounded-2xl p-6 border border-white/10 hover:border-yellow-500/30 
                transition-all duration-300 hover:scale-105 hover:shadow-xl">
                <div className="flex items-center justify-between mb-3">
                  <i className="fas fa-fire text-2xl text-yellow-500 
                    group-hover:scale-110 transition-transform"></i>
                </div>
                <p className="text-text-secondary text-sm">Calorias Totais</p>
                <p className="text-3xl font-bold text-white">{stats?.totalCalories || 0}</p>
                <p className="text-xs text-yellow-500 mt-1">kcal</p>
              </div>

              <div className="group bg-gradient-to-br from-secondary-dark/50 to-black/50 
                rounded-2xl p-6 border border-white/10 hover:border-accent-blue/30 
                transition-all duration-300 hover:scale-105 hover:shadow-xl">
                <div className="flex items-center justify-between mb-3">
                  <i className="fas fa-heartbeat text-2xl text-accent-blue 
                    group-hover:scale-110 transition-transform"></i>
                </div>
                <p className="text-text-secondary text-sm">FC Média</p>
                <p className="text-3xl font-bold text-white">{stats?.avgHeartRate || 0}</p>
                <p className="text-xs text-accent-blue mt-1">bpm</p>
              </div>

              <div className="group bg-gradient-to-br from-secondary-dark/50 to-black/50 
                rounded-2xl p-6 border border-white/10 hover:border-accent-green/30 
                transition-all duration-300 hover:scale-105 hover:shadow-xl">
                <div className="flex items-center justify-between mb-3">
                  <i className="fas fa-clock text-2xl text-accent-green 
                    group-hover:scale-110 transition-transform"></i>
                </div>
                <p className="text-text-secondary text-sm">Horas de Treino</p>
                <p className="text-3xl font-bold text-white">{stats?.totalHours || 0}</p>
                <p className="text-xs text-accent-green mt-1">horas</p>
              </div>
            </div>
          )}
        </div>
